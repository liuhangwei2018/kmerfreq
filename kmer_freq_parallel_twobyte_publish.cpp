...
//Parallel styple: the disk reading (main thread) and kmer computation (children threads) are performed simutaneously, use CAS(compare and swap) lock-free approach in the children threads, the loading data from disk and Kmer computation are doing simutaneously.
...
/////////////////////////////////////////////////////////////////////////////////
	...
	cerr << "Parsing all the reads files completed" << endl;
	time_end = clock();
	cerr << "Run time: " << double(time_end - time_start) / CLOCKS_PER_SEC << endl;
...
/////////////////////////////////////////////////////////////////////////////////
	...
	cerr << "Make statistics of kmer frequency done \n" << endl;
